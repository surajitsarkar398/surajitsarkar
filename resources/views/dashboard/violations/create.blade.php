                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input class="form-control @error('reason_in_arabic') is-invalid @enderror"
                               type="text" value="{{ old('reason_in_arabic') }}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input class="form-control @error('reason_in_english') is-invalid @enderror"
                               type="text" value="{{ old('reason_in_english') }}"
                               id="example-text-input"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <select name="addition_to"
                                ...
                                title="{{__('Select')}}">
                            <option value="minutes_deduc" @if(old('addition_to') == "minutes_deduc") selected @endif>{{__('Determine the late minutes')}}</option>
                            <option value="leave_days" @if(old('addition_to') == "leave_days") selected @endif>{{__('Discounting the period of leaving work')}}</option>
                        </select>
                    </div>
                </div>
            </div>
