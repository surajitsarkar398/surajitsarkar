        ...
        <div class="kt-portlet__head kt-portlet__head--lg">
            ...
            <div class="kt-portlet__head-toolbar">
                <div class="kt-portlet__head-wrapper">
                    ...
                    <a href="{{route('dashboard.vacation_types.create')}}" class="btn btn-brand btn-icon-sm">
...
@push('scripts')
    <script src="{{asset('js/datatables/vacation_types.js')}}" type="text/javascript"></script>
@endpush
