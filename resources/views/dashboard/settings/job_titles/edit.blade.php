...
@section('content')
    ...
    <div class="kt-subheader   kt-grid__item" id="kt_subheader">
        <div class="kt-container  kt-container--fluid ">
            ...
            <div class="kt-subheader__toolbar">
                ...
                <a href="{{route('dashboard.job_titles.index')}}" class="btn btn-secondary">
                    {{__('Back')}}
                </a>
            </div>
        </div>
    ...
    <div class="kt-portlet">
        ...
        <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action="{{route('dashboard.job_titles.update',$job_title)}}">
            @method('PUT')
            @csrf
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6 col-md-9 col-sm-12">
                    <input class="form-control @error('name_ar') is-invalid @enderror"
                           type="text"
                           value="{{ old('name_ar') ?? $job_title->name_ar }}"
            ...
            <div class="form-group row">
                ...
                <div class="col-lg-6 col-md-9 col-sm-12">
                    <input class="form-control @error('name_en') is-invalid @enderror"
                           type="text"
                           value="{{ old('name_en') ?? $job_title->name_en }}"
                           id="example-text-input"
                           name="name_en">
                    @error('name_en')
                ...
                <div class="kt-form__actions">
                    <div class="row">
                        <div class="col-lg-12">
                            ...
                            <a href="{{route('dashboard.job_titles.index')}}" class="btn btn-secondary">{{__('back')}}</a>
                        </div>
                    </div>
                </div>
            </div>
