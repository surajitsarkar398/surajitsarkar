...
@section('content')
    ...
    <!--begin::Form-->
        <form class="kt-form kt-form--label-right" method="POST" action="{{route('dashboard.leave_balances.update', $leaveBalance->id)}}"
                ...
                <div class="form-group row">
                    ...
                    <div class="col-lg-6 col-md-9 col-sm-12">
                        <input name="days_per_year"
                               id="days_per_year"
                               value="{{old('days_per_year') ?? $leaveBalance->days_per_year}}"
